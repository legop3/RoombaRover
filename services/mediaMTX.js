...
function buildExternalMTXYaml() {
  ...
  const webrtcReadBufferCount = sanitizePositiveInt(REMOTE_CFG_RAW?.webrtcReadBufferCount, DEFAULT_WEBRTC_READ_BUFFER_COUNT);
  const webrtcWriteQueueSize = sanitizePositiveInt(REMOTE_CFG_RAW?.webrtcWriteQueueSize, DEFAULT_WEBRTC_WRITE_QUEUE_SIZE);
...
webrtcReadBufferCount: ${webrtcReadBufferCount}
webrtcWriteQueueSize: ${webrtcWriteQueueSize}
